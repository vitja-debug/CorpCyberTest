...
def kb_tests_menu() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [KeyboardButton(text="🤖 Згенерувати тест ШІ")],
            [KeyboardButton(text="🏠 Головне меню")],
        ],
        resize_keyboard=True,
    )
...
def kb_ai_test_menu() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="Згенерувати 10 питань")],
            [KeyboardButton(text="Згенерувати 20 питань")],
            [KeyboardButton(text="Згенерувати 30 питань")],
            [KeyboardButton(text="Згенерувати 40 питань")],
            [KeyboardButton(text="🏠 Головне меню")],
        ],
        resize_keyboard=True,
    )
